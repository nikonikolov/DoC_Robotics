...
motorParamsLeft.pidParameters.k_p = .65*G
#motorParamsLeft.pidParameters.k_i = 2*motorParamsLeft.pidParameters.k_p/T*0.3
motorParamsLeft.pidParameters.k_i = 1.7*motorParamsLeft.pidParameters.k_p/T*0.3
...
motorParamsRight.pidParameters.k_i = 0.5*motorParamsRight.pidParameters.k_p/T*0.3
